...
const HighlightImageModal = ({ showHighlight, setshowHighlight, product , children}) => {
    ...
    return (
        <>
            ...
            <div
                ...
                tabindex="-1"
                aria-hidden="true"
                className={`fixed top-0 left-0 right-0 z-50 ${showHighlight ? "" : "hidden"
...
export default HighlightImageModal
