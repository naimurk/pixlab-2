    ...
    <main>
      <div style={{ padding: "16px" }}>
        <div className="md:w-[70%] m-auto">
          ...
          <ul>
            <li className="my-4 text-lg text-gray-500">
              <p className="my-4 text-lg text-gray-500">
            ...
            <li className="my-4 text-lg text-gray-500">
              <p className="my-4 text-lg text-gray-500">
                <strong>Application</strong> refers to pixlab, the software
          ...
          <ul>
            <li className="my-4 text-lg text-gray-500">Usage Data</li>
          </ul>
          <h3>Usage Data</h3>
          <p className="my-4 text-lg text-gray-500">
          ...
          <ul>
            <li className="my-4 text-lg text-gray-500">
              ...
              <p className="my-4 text-lg text-gray-500">Administered by: Us</p>
              <p className="my-4 text-lg text-gray-500">
