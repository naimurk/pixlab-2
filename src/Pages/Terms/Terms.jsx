    ...
    <main>
      <div style={{ padding: "16px" }}>
        <div className="md:w-[70%] m-auto">
          ...
          <ul>
            ...
            <li>
              <p className="my-4 text-lg text-gray-500">
                ...
                in this Agreement) refers to pixlab.
              </p>
            </li>
            <li>
              <p className="my-4 text-lg text-gray-500">
            ...
            <li>
              <p className="my-4 text-lg text-gray-500">
                <strong>Website</strong> refers to pixlab, accessible from{" "}
                <Link
          ...
          <h1 className="text-4xl font-bold ">Acknowledgment</h1>
          <p className="my-4 text-lg text-gray-500">
          ...
          <h1 className="text-4xl font-bold ">Termination</h1>
          <p className="my-4 text-lg text-gray-500">
          ...
          <h1 className="text-4xl font-bold ">Limitation of Liability</h1>
          <p className="my-4 text-lg text-gray-500">
          ...
          <h1 className="text-4xl font-bold ">Governing Law</h1>
          <p className="my-4 text-lg text-gray-500">
          ...
          <h1 className="text-4xl font-bold ">Disputes Resolution</h1>
          <p className="my-4 text-lg text-gray-500">
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h1 className="text-4xl font-bold ">For European Union (EU) Users</h1>
          <p className="my-4 text-lg text-gray-500">
          ...
          <h1 className="text-4xl font-bold ">Severability and Waiver</h1>
          <h2>Severability</h2>
          <p className="my-4 text-lg text-gray-500">
          ...
          <h1 className="text-4xl font-bold ">Translation Interpretation</h1>
          <p className="my-4 text-lg text-gray-500">
          ...
          <ul>
            <li>
              <p className="my-4 text-lg text-gray-500">
                By email: pixlabeditor@gmail.com
              </p>
            </li>
            <li>
              <p className="my-4 text-lg text-gray-500">
                ...
                <Link
                  to="https://www.pixlab.in/contact"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://www.pixlab.in/contact
                </Link>
              </p>
            </li>
          </ul>
